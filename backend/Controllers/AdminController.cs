...
namespace Examhub.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        private bool IsAdmin()
        {
            ...
            return _context.Users.Any(u => u.Id == userId && u.UserType == "Admin");
        }
        ...
        {
            if (!IsAdmin()) return Unauthorized("Only admins can perform this action.");
        ...
        public async Task<IActionResult> UploadStudyMaterial([FromForm] string title, int? categoryId, int? topicId, IFormFile file)
        {
            ...
            var material = new StudyMaterial
            {
                ...
                UploadedById = GetLoggedInUserId()
            };
